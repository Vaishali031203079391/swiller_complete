...
import datatable from '../../../../../data/restarunts_list.json';
import { LocalDataSource } from 'ng2-smart-table';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';

@Component({
  selector: 'app-restarunt-overview',
  templateUrl: './restarunt-overview.component.html',
  styleUrls: ['./restarunt-overview.component.css']
})
export class RestaruntOverviewComponent implements OnInit {
  ...
  // Pie Chart
  public PieChartLabels: Label[] = ["R1", "R2", "R3", "R4", "R5"];
  ...
  public PieChartOptions: ChartOptions = {
    ...
    title: {
      display: true,
      text: 'Overview Of Restarunts Ratings',
      fontColor: "#A8A9AD"
    }
  }
