...
import datatable from '../../../../../data/bookings_admin.json';
  ...
  onSearch(query: string = '') {
    this.source.setFilter([
      // fields we want to include in the search
      {
        ...
        field: 'bookings_confirmed',
        search: query
      },{
        field: 'bookings_pending',
        search: query
      },{
        field: 'bookings_completed',
        search: query
      },{
        field: 'bookings_cancelled',
        search: query
      }
    ], false);
  }
